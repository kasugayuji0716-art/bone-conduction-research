...
// 7. 次の方向：本命
{
  ...
  const rows = [
    ...
    ["手がかり", rich(["自己教師あり表現（WavLMなど）を損失に使うと、", { b: "学習に使っていないASRでも改善した" }, "という報告がある（Sato 2025、Ravenscroft 2024）。今回のEnc L1（Whisperの表現に近づける損失）は特化は起きなかったが、改善もしなかった"])],
