...
const content = [
  ...
  p([txt("一方、提案手法のCER 0.200はWhisperファインチューニング（CER 0.136）には及ばない。しかし、SEはASRモデルに依存しない前処理であり、モデル更新のたびに再学習が不要という利点がある。本研究はWhisper系列内での評価に限られており、異なるASRアーキテクチャや他言語への汎化は今後の検証課題である。")]),
